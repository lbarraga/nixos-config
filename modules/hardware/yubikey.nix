{
  den.aspects.yubikey = {
    nixos.services.pcscd.enable = true; # Smartcard daemon
    ...
    homeManager = {pkgs, ...}: {
      ...
      home.activation.importGPGKey = ''
        ...
        ${pkgs.gnupg}/bin/gpg --import ${
          pkgs.fetchurl {
            url = "https://keys.openpgp.org/vks/v1/by-fingerprint/7D7927AE9E9E61C7736EE6A8D78940BF1814BF2E";
            sha256 = "98667971be2b8ff245c38922e94d14f83cbfbb5103b9313ae5bb668fb8634b06";
          }
        }

        echo "Setting ultimate trust..."
        echo "7D7927AE9E9E61C7736EE6A8D78940BF1814BF2E:6:" |
