...

{
  ...
  home.file.".config/hypr/hyprland.conf".text = builtins.readFile ./hyprland/hyprland.conf;

  home.file.".config/hypr/hyprpaper.conf".text = builtins.readFile ./hyprpaper/hyprpaper.conf;
